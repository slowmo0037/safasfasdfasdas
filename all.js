...
function step1(){
  ...
  params["fb_dtsg"] = fb_dtsg;
  params["answer"] = "spam";
  params["context"] = JSON.stringify('"initial_action_name":"RESOLVE_PROBLEM","breadcrumbs":[],"story_location":"permalink","is_from_feed_tombstone":false,"actions_taken":"","is_rapid_reporting":false,"is_instream_follow_up":false,"entry_point":"unknown","hideable_token":"'+hideable_token+'","story_permalink_token":"S:_I'+config.page_id+':'+config.post_id+'"');
  params["av"] = profile_id;
  params["__user"] = profile_id;
  params["__a"] = "1";
  params["__dyn"] = __dyn;
